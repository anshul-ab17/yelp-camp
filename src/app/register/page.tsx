...
import { UserPlus, Mail, User as UserIcon, Lock, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md p-8 rounded-3xl glass-panel relative overflow-hidden shadow-2xl border border-emerald-500/10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-foreground/60 mt-1">Join YelpCamp and share your camps</p>
        </div>
        ...
        <form action={formAction} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 h-5 w-5 text-foreground/40" />
              <input
                id="email"
                name="email"
                type="email"
        ...
        <p className="text-sm text-center text-foreground/60 mt-6">
          ...
          <Link href="/login" className="font-semibold text-primary-emerald hover:underline">
            Login
          </Link>
        </p>
      </div>
